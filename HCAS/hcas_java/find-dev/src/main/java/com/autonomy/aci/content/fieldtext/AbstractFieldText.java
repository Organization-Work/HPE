/*
 * $Id: //depot/products/aci/api/public/java/ContentParameter/src/main/java/com/autonomy/aci/content/fieldtext/AbstractFieldText.java#3 $
 *
...
public abstract class AbstractFieldText implements FieldText {
     ...
     */
    //@Override
    // Currently not public or part of the interface because WHEN is awkward... see Specifier
