/*
 * $Id: //depot/products/aci/api/public/java/ContentParameter/src/main/java/com/autonomy/aci/content/fieldtext/FieldTextBuilder.java#4 $
 *
 * Copyright (c) 2008-2010, Autonomy Systems Ltd.
 *
 * Last modified by $Author: boba $ on $Date: 2011/02/18 $
 */
 ...
 * </pre>
 */
public final class FieldTextBuilder implements FieldText {
     ...
     * @return {@code this}
     */
    // Currently not public, see Specifier
    @Override
