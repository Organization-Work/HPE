/*
 * $Id: //depot/products/aci/api/public/java/ContentParameter/src/main/java/com/autonomy/aci/content/fieldtext/FieldText.java#2 $
 *
...
public interface FieldText {
     ...
     */
    // Disabled for now... we only allow Specifier WHEN Specifier
