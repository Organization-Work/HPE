...
import com.autonomy.find.dto.TrendingData;
 ...
 */
@Data
public class TrendingTotalsResponse {
    private TrendingTotalsData tdata;

	public void setData(TrendingTotalsData tdata) {
		this.tdata=tdata;
	}
}
