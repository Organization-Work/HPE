...
function sendFeedback() {
	...
	document.getElementById('hp-feedbackOpen').href = 'mailto:' + commentsEmailAddress + '?subject=Feedback on ' + productName + " " + productVersion + " documentation: " + firstheading + '&body=' + line + emailBody + line; 	
