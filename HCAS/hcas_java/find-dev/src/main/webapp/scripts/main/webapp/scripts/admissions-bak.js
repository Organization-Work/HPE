$(function(){
    ...
    if (top.SearchSettings && !$('#restricted').length) {
        ...
        if (filterGroup) {
            ...
            SearchEvents.getFolders = top.SearchEvents.getFolders;
            SearchEvents.getNonRestrictedFolders = top.SearchEvents.getNonRestrictedFolders;
            SearchEvents.getRestrictedFolders = top.SearchEvents.getRestrictedFolders;
    ...
    if (top.SearchEvents && top.SearchEvents.getCheckedFolders) {
        ...
        if (folders.length) {
            ...
            var documentFolderTemplate = _.template($.resGet('../templates/search/documentfolder.tagger'+tempID+'.template'), undefined, {variable: 'ctx'});
